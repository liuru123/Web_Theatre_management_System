...
<div style="height:105px;line-height:75px;font-size:25px;vertical-align: middle;text-align: center" class="bg-primary">  <img src="../images/横版logo.png"></div>
    ...
    <div class="row" style="padding:10px 10px">
        ...
        <div class="col-md-10" style="padding-top:10px">
         <form class="form-horizontal" role="form" action="modifyPass"   enctype="multipart/form-data"  method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text"  disabled="disabled"    class="form-control" id="type" name="user_type"  value ="${user.user_type }">
                    </div>
                </div>
              <div class="form-group">
